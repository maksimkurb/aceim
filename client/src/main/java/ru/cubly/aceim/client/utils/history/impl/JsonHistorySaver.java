package ru.cubly.aceim.client.utils.history.impl;
...
public final class JsonHistorySaver implements HistorySaver {
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.utils.HistorySaver#saveMessage(aceim.app.api.dataentity.Buddy, aceim.app.api.dataentity.BaseMessage)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.utils.HistorySaver#getMessages(aceim.app.api.dataentity.Buddy)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.utils.HistorySaver#getMessages(aceim.app.api.dataentity.Buddy, int, int)
	 */
	@Override
