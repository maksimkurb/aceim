...
public abstract class ContactList extends Page implements IHasAccount, IHasMessages, IHasFilePicker {
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.dataentity.listeners.IHasMessages#messageReceived(aceim.app.api.dataentity.BaseMessage)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.dataentity.listeners.IHasMessages#messageAckReceived(long, aceim.app.api.dataentity.MessageAckState)
	 */
	@Override
	public void onMessageAckReceived(long messageId, MessageAckState ack) {}

	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.dataentity.listeners.IHasMessages#hasMessagesOfBuddy(byte, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.dataentity.listeners.IHasBuddy#onBuddyIcon(byte, java.lang.String)
	 */
	/*@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.client.dataentity.listeners.IHasAccount#onAccountIcon(byte)
	 */
	@Override
