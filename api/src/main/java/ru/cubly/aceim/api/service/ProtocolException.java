...
/**
 * Exception used in several core calls. See {@link ICoreProtocolCallback#connectionStateChanged(byte, ru.cubly.aceim.api.dataentity.ConnectionState, int)} for sample.
 */
