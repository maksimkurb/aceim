...
import ru.cubly.aceim.client.dataentity.listeners.IHasAccount;
import ru.cubly.aceim.client.dataentity.listeners.IHasAccountList;
import ru.cubly.aceim.client.dataentity.listeners.IHasBuddy;
import ru.cubly.aceim.client.dataentity.listeners.IHasFilePicker;
import ru.cubly.aceim.client.dataentity.listeners.IHasFileProgress;
import ru.cubly.aceim.client.dataentity.listeners.IHasMessages;
import ru.cubly.aceim.client.screen.Screen;
import ru.cubly.aceim.client.service.ICoreService;
import ru.cubly.aceim.client.service.IUserInterface;
import ru.cubly.aceim.client.utils.DialogUtils;
import ru.cubly.aceim.client.utils.LinqRules.AccountListPageLinqRule;
import ru.cubly.aceim.client.utils.LinqRules.AccountPageLinqRule;
import ru.cubly.aceim.client.utils.LinqRules.BuddyPageLinqRule;
import ru.cubly.aceim.client.utils.LinqRules.FileProgressPageLinqRule;
import ru.cubly.aceim.client.utils.LinqRules.MessagePageLinqRule;
import ru.cubly.aceim.client.utils.LinqRules.ProtocolAccountPageLinqRule;
import ru.cubly.aceim.client.utils.ViewUtils;
import ru.cubly.aceim.client.page.Page;
import ru.cubly.aceim.client.page.chat.Chat;
import ru.cubly.aceim.client.page.contactlist.ContactList;
import ru.cubly.aceim.client.page.inputform.InputFormFeaturePage;
import ru.cubly.aceim.client.page.transfers.FileTransfers;
import ru.cubly.aceim.client.widgets.bottombar.BottomBarButtonInfo;
...
public class MainActivity extends AceIMActivity {
	...
	private void initCoreService() {
		if (mCoreServiceIntent == null) {
			mCoreServiceIntent = new Intent("ru.cubly.aceim.client.service.CoreService");
		}
