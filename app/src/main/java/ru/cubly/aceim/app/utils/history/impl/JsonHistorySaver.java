...
public final class JsonHistorySaver implements HistorySaver {
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.app.utils.HistorySaver#saveMessage(aceim.app.api.dataentity.Buddy, aceim.app.api.dataentity.Message)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.app.utils.HistorySaver#getMessages(aceim.app.api.dataentity.Buddy)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.cubly.aceim.app.utils.HistorySaver#getMessages(aceim.app.api.dataentity.Buddy, int, int)
	 */
	@Override
